...
import 'package:flutter_gemini_we_final_project/widgets/preview_images_widget.dart';
            ...
            children: [
              ...
              GestureDetector(
                ...
                onTap: (){
                  if (textController.text.isNotEmpty) {
                    // send the message
                  sendChatMessage(message: textController.text, chatProvider: widget.chatProvider,
                  isTextOnly: true,
                   );
                 }
                },
